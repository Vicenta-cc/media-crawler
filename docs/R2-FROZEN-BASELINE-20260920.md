...
完整运行文件与操作说明在 [应用文档分支](https://github.com/Vicenta-cc/audit-agent-demo/tree/codex/r2-frozen-handoff-20260920/deploy/r2-frozen-20260918)。当前 Git 仓库不是包含全部依赖和账号数据的容器镜像；pyproject.toml/requirements.txt 用于依赖声明，重建后仍需重新验收。
