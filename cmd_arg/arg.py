...
async def parse_cmd(argv: Optional[Sequence[str]] = None):
    ...
    def main(
        ...
        get_media: Annotated[
            ...
            typer.Option(
                "--get_media",
                help="Whether to crawl media files, supports yes/true/t/y/1 or no/false/f/n/0",
        ...
        stream_items: Annotated[
            ...
            typer.Option(
                "--stream_items",
                help="Whether to process and persist items one by one for streaming consumers",
        ...
        background_browser: Annotated[
            str,
            typer.Option(
                "--background_browser",
                help="Auto-hide browser when saved login state exists, and reopen visibly when QR/manual login is required",
                rich_help_panel="Runtime Configuration",
                show_default=True,
            ),
        ] = str(config.ENABLE_BACKGROUND_BROWSER_MODE),
        ...
        config.ENABLE_BACKGROUND_BROWSER_MODE = enable_background_browser
